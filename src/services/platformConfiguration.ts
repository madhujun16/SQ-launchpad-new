...
const mockRecommendationRules: RecommendationRule[] = [
  ...
  },
  {
    id: '2',
    softwareModuleId: 'sw-pos-system',
    hardwareItemId: 'hw-receipt-printer',
    defaultQuantity: 1,
    isRequired: true,
  ...
  {
    id: '4',
    softwareModuleId: 'sw-kiosk-software',
    hardwareItemId: 'hw-kiosk-display',
    defaultQuantity: 1,
    isRequired: true,
  ...
  {
    id: '6',
    softwareModuleId: 'sw-kitchen-display',
    hardwareItemId: 'hw-kiosk-display',
    defaultQuantity: 1,
    isRequired: true,
  ...
  {
    id: '7',
    softwareModuleId: 'sw-inventory-mgmt',
    hardwareItemId: 'hw-barcode-scanner',
    defaultQuantity: 1,
    isRequired: true,
...
const mockBusinessRules: BusinessRule[] = [
  ...
  },
  {
    ...
    ruleType: 'dependency',
    softwareModuleIds: ['sw-kiosk-software'],
    hardwareItemIds: ['hw-kiosk-display', 'hw-receipt-printer'],
    ruleValue: 'required',
    priority: 2,
    costImpact: 1400,
    conditionalLogic: null
  },
  {
    ...
    ruleType: 'quantity',
    softwareModuleIds: ['sw-kitchen-display'],
    hardwareItemIds: ['hw-kiosk-display'],
    ruleValue: '1',
    priority: 3,
    costImpact: 450,
    conditionalLogic: null
