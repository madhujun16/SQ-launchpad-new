...
const SimpleDeploymentEngineerDashboard: React.FC = () => {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight">Deployment Engineer Dashboard</h1>
        <p className="text-muted-foreground">
          Track deployment progress and tasks
        </p>
      </div>
...
export default SimpleDeploymentEngineerDashboard;