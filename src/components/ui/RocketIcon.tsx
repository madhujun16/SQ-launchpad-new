...
/**
 * RocketIcon Component - SmartQ Launchpad Logo
 * 
  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <path fill="#43A047" d="M77.5 16a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11m0-2c-4.137 0-7.5 3.364-7.5 7.5s3.363 7.5 7.5 7.5 7.5-3.364 7.5-7.5-3.363-7.5-7.5-7.5z"/>
