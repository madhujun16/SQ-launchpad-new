-- Migration to remove 'user' role from app_role enum
-- Drops and recreates RLS policies to avoid dependencies
...
-- Step 3: Drop RLS policies that depend on role column
...
-- Step 9: Recreate the RLS policies for licenses
...
-- Step 10: Update the has_role function to use the new enum
...
-- Step 11: Update the get_current_user_roles function
...
-- Step 12: Update the is_admin function
