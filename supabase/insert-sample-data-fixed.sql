-- Sample Data Insertion Script for SmartQ Launchpad CG (Fixed Version)
-- This script matches the actual database structure
...
-- Insert Sample Profiles (Users) - Using existing structure
INSERT INTO public.profiles (id, user_id, email, full_name, created_at, updated_at) VALUES
('770e8400-e29b-41d4-a716-446655440001', gen_random_uuid(), 'admin@smartq.com', 'System Administrator', now(), now()),
('770e8400-e29b-41d4-a716-446655440002', gen_random_uuid(), 'ops.manager@smartq.com', 'Ops Manager', now(), now()),
('770e8400-e29b-41d4-a716-446655440003', gen_random_uuid(), 'deployment.engineer@smartq.com', 'Deployment Engineer', now(), now()),
